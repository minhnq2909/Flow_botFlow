  ...
  return (
    <BaseNode {...props} showOutput={false}>
      ...
      <Handle
        ...
        className="!top-[44%] !h-3 !w-3 !bg-green-600"
      />
      <Handle
        id="false"
        type="source"
        position={Position.Right}
        className="!top-[72%] !h-3 !w-3 !bg-red-600"
      />
      <span className="absolute right-3 top-[38%] text-[10px] font-semibold text-green-700">
        True
      </span>
      <span className="absolute right-3 top-[66%] text-[10px] font-semibold text-red-700">
        False
      </span>
    </BaseNode>
  );
